...
public class JukeBoxIter2 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		listView = new ListView<String>(songCollection.getSongQueueTitles());
	...
	private class ButtonListener implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent arg) {
			...
			if (buttonClicked.getText().equals("Play")) {
				...
				//System.out.printf("song chosen:" + songViewer.getSelectionModel().getSelectedItem().toString());
				if (currentUser != null) {
